...
$classq = mysqli_query($conn, $selClass) or die(mysqli_error($conn));
...
$studentsq = mysqli_query($conn, $selStudents) or die(mysqli_error($conn));
...
$studentsClassq = mysqli_query($conn, $selStudentsClass) or die(mysqli_error($conn));
